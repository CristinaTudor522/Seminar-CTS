...
public class TestRegistruSingleton {
	...
	public static void main(String[] args) {
		...
		ConexiuneBD conexiune1=ConexiuneBD.getConexiune("10.10.0.1", "cts");
		ConexiuneBD conexiune2=ConexiuneBD.getConexiune("10.10.0.2", "cts");
		ConexiuneBD conexiune3=ConexiuneBD.getConexiune("10.10.0.2", "test");
